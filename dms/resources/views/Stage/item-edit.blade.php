              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form id="formAddActivity" method="post" action="{{action('ItemController@update', $item->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <input type="text" name="actID" value="{{$actID}}" hidden>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-4">
                          <button onclick="window.location='/Stage/Activity/{{$actID}}';" class="btn btn-primary">Cancel</button>
