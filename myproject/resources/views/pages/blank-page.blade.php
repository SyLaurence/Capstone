                    ...
                    <ul class="nav side-menu">
                        ...
                        <li><a><i class="fa fa-check-square-o"></i> Criteria for Evaluation <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="perf-app.html">Performance Appraisal</a></li>
                                <li><a href="line-fam.html">Line Familiarization</a></li>
                                <li><a href="road-test.html">Road Test</a></li>
                            </ul>
                        </li>
                        <li><a><i class="fa fa-tasks"></i> Reqruitment Process <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="stages.html">Stages</a></li>
                                <li><a href="stg-act.html">Activities</a></li>
                            </ul>
                        </li>
                        <li><a href="javascript:void(0)"><i class="fa fa-users"></i> Accounts </a></li>
                    </ul>
                </div>
