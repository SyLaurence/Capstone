            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                  <div class="x_content">
                      ...
                      <form action="{{route('CompanyBrand.store')}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        {{csrf_field()}}
                          ...
                          <div class="form-group">
                              <div class="col-md-6 col-md-offset-3">
                                  <button onclick="window.location='/pages/CompanyBrand/bus';" class="btn btn-primary">Cancel</button>
