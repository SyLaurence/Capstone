            ...
            <div class="page-title">
                <div class="title_left">
                    <h4>
                      ...
                      <a href="recruitement-view-details.html">PROCESS NAME</a> >
                      <a href="recruitement-view-details.html">STAGE NAME</a> >
                      <a href="recruitement-view-details.html">ACITVITY NAME</a> >
                      items
                    </h4>
                </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_title">
                   <ul class="nav navbar-right panel_toolbox">
                      <li>
                        <a href="account-add.html">Add new activity</a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table id="tableItems" class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>-</td>
                          <td>
                            <input type="button" class="btn btn-primary" value="Edit" onclick="location.href = 'activity-item-edit.html';">
                            <input type="button" class="btn btn-danger btnDelete" value="Delete">
                          </td>
                        </tr>
                        <tr>
                          <td>Name</td>
