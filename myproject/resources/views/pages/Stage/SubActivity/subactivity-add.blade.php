  ...
  <body class="nav-md">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                ...
                                <form id="formAddActItem" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                      ...
                                      <div class="col-md-6 col-sm-6 col-xs-12">
                                          <select name="txtItemType" id="txtItemType" class="form-control" required>
                                              ...
                                              <option value="Check" id="cmbxCheck">Check</option>
    ...
    <script>
      $(document).ready(function(){
        ...
        $("#formAddActItem").submit(function(){
