                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_content">
                                ...
                                <form action="{{route('Activity.store')}}" method="post" id="formAddActivity" data-parsley-validate class="form-horizontal form-label-left">

                                {{csrf_field()}}
                                <input type="text" id="stgID" name="stgID" value="{{$stgID}}" hidden>
