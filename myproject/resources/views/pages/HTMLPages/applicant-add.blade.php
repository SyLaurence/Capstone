        ...
        <div class="right_col" role="main">
                        ...
                        <div class="x_panel">
                            <div class="x_content">
                                ...
                                <div id="smartwizard">
                                    ...
                                    <form id="formData" action="{{route('PersonalInfo.store')}}" method="post" hidden>
                                        {{csrf_field()}}
                                        ...
                                        <input type='text' id='hdPxm' name='hdPxm' hidden>
                                        <!-- ********** JSON DATA ********** -->
                                    ...
                                    <div>
                                        ...
                                        <div id="step-2" class="">
                                            ...
                                            <form id="formPInfo" data-parsley-validate class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" id="txtHeight" name="txtHeight" min="1" step="any" required="required" placeholder="in feet" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="number" id="txtWeight" name="txtWeight" min="1" step="any" required="required" placeholder="in kg" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="txtContact" name="txtContact" required="required" data-parsley-type="digits" class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="txtSSS" name="txtSSS" data-parsley-minlength="10" data-parsley-maxlength="10" data-parsley-type="digits"  class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="txtTIN" name="txtTIN" data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="digits"  class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="txtPhilHealth" name="txtPhilHealth" data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="digits"  class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <input type="text" id="txtPagIbig" name="txtPagIbig" data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="digits"  class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="step-3" class="">
                                            ...
                                            <form id="formEducBackground" data-parsley-validate class="form-horizontal form-label-left">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="txtCollegeName" name="txtCollegeName"  placeholder="Name" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" id="txtCollegeAddress" name="txtCollegeAddress" placeholder="Address" class="form-control col-md-7 col-xs-12">
                                                    </div>
                                                </div>
            ...
            <div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                <div class="modal-dialog">
                    <div claBus Companyss="modal-content">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            //return confirm("Do you want to leave the step "+stepNumber+"?");
				...
				if(stepNumber == 0){
					//alert("personal info besh");
					if($("#formPInfo").parsley().validate() )
    				console.log('valid');
    			else{
    				//alert ('invalid');
