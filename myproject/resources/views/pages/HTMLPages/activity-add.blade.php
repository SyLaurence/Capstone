                  ...
                  <form id="formData" action="{{route('Stage.store')}}" method="post" hidden>
                    ...
                    <form id="formAddActivity" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="txtStageNum" name="txtStageNum" required="required" min="1" step="1" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" data-parsley-type="digits"  class="form-control col-md-7 col-xs-12"/>
                        </div>
											</div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="txtActNum" name="txtActNum" required="required" min="1" step="1" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" data-parsley-type="digits"  class="form-control col-md-7 col-xs-12"/>
                        </div>
											</div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="txtTargetDays" name="txtTargetDays" required="required" min="0" step="1" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" data-parsley-type="digits"  class="form-control col-md-7 col-xs-12"/>
                        </div>
											</div>
                      <div class="item form-group">
